            ...
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <div class="col-md-12 layout-spacing">
                    <div class="widget widget-card-four">
                        ...
                        <form method="POST" class="form-vertical" action="<?= base_url('Admin/updateJenisKuliner/' . $jenis_kuliner->id) ?>" enctype="multipart/form-data">
                            <div class="form-group mb-4">
                                <label class="control-label">Nama Jenis Kuliner</label>
                                <div class="input-group mb-4">
                                    <input type="text" name="nama" class="form-control" value="<?= $jenis_kuliner->nama ?>" required>
                                </div>
                            </div>
                            <a href="<?= base_url('Admin/jenisKuliner') ?>" class="btn btn-danger">Back</a>
