...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="<?= base_url('User') ?>">
                    <img style="border-radius: 50px" src="<?= base_url() ?>assets/img/depok.jpg" class="navbar-logo" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="<?= base_url('User') ?>" class="nav-link"> SIWIKODE</a>
            </li>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu <?php $this->uri->segment(2) == "" || $this->uri->segment(2) == "detail" ? print("active") : print('') ?>">
                <a href="<?= base_url('User') ?>" aria-expanded="<?php $this->uri->segment(2) == "" || $this->uri->segment(2) == "detail" ? print("true") : print('false') ?>" class="dropdown-toggle">
                    <div class="">
